...
public class MediaPipelineFactory {
    ...
    private static final String VIDEO_BIN_DESCRIPTION = "dxgiscreencapsrc cursor=true ! capsfilter caps=\"video/x-raw,framerate=60/1\" ! nvh264enc bitrate=0 rc-mode=cbr gop-size=-1 qos=true preset=low-latency-hq ! capsfilter caps=\"video/x-h264,profile=high\" ! rtph264pay ! capsfilter caps=\"application/x-rtp,media=video,encoding-name=H264,payload=123\"";
